...
//! can coexist. Replication uses [`slog::EventStoreReader`].
//!
...
//! [`slog::ReaderConfig::options`]; SlateDB's default is 10s) plus the sync
...
use slog::{Error, Event, EventStoreReader, Result, Version};
...
impl Replica {
    ...
    /// ([`EventStore::purge_below`](slog::EventStore::purge_below) /
